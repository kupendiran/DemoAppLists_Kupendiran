...
func showProgressIndicator(view:UIView){
    ...
    progressIndicator.activityIndictor.color = .white
    progressIndicator.tag = Constants.AppDatas.PROGRESS_INDICATOR_VIEW_TAG
...
func hideProgressIndicator(view:UIView){
    ...
    if let viewWithTag = view.viewWithTag(Constants.AppDatas.PROGRESS_INDICATOR_VIEW_TAG) {
